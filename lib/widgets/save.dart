...
class SaveXml {
  ...
  static void updateData() {
    ...
    fetchedDetails.addAll({
      ...
      "xNotificationAlign": assetsController.xNotificationAlign().text,
      "yNotificationAlign": assetsController.yNotificationAlign().text,
      "scaleNotification": assetsController.scaleNotification().text,
      "alphaNotification": assetsController.alphaNotification().text,
      "countNotification": assetsController.countNotification().text,
      "colorNotification": "'#${assetsController.colorNotification().text}'",
    });
  }
}
